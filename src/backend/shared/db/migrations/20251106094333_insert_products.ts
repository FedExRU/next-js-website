...
export const up = async (knex: Knex) => {
  ...
  const service = new SharpImageService(
    resolve(__dirname, './assets/apex_closet_biege_1.jpg'),
  )
  ...
  await service
    .input(resolve(__dirname, './assets/apex_closet_biege_2.jpeg'))
    .save()
  ...
  await service
    .input(resolve(__dirname, './assets/apex_closet_biege_3.jpeg'))
    .save()
  ...
  await service
    .input(resolve(__dirname, './assets/apex_closet_biege_4.jpeg'))
    .save()
  ...
  await knex
    .insert([
      {
        code: 'CLOSET_APEX_BIEGE',
        created_by: 1,
        description:
          'The Apex Closet offers a sleek and efficient storage solution for any room. Designed with soft-close doors, the Apex helps you organize your belongings with ease.',
        name: 'Closet Apex Biege',
        updated_by: 1,
      },
    ])
    .into('galleries')
  ...
  await knex
    .insert([
      {
        created_by: 1,
        product_base_attribute_id: 7,
        updated_by: 1,
        value: '300',
      },
      {
        created_by: 1,
        product_base_attribute_id: 8,
        updated_by: 1,
        value: '100',
      },
      {
