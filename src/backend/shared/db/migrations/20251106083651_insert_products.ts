...
export const up = async (knex: Knex) => {
  // #region Insert Tray Table Red
  const service = new SharpImageService(
    resolve(__dirname, './assets/tray_table_red_1.jpg'),
  )
  ...
  await service
    .input(resolve(__dirname, './assets/tray_table_red_2.jpeg'))
    .save()
  ...
  await service
    .input(resolve(__dirname, './assets/tray_table_red_3.jpeg'))
    .save()
  ...
  await service
    .input(resolve(__dirname, './assets/tray_table_red_4.jpeg'))
    .save()
  ...
  await knex
    .insert([
      {
        code: 'TRAY_TABLE_KENSINGTON_RED',
        created_by: 1,
        description:
          'Buy one or buy a few and make every space where you sit more convenient. Light and easy to move around with removable tray top, handy for serving snacks.',
        name: 'Tray Table Kensington Red',
        updated_by: 1,
      },
    ])
    .into('galleries')
    ...
    .insert([
      {
        ...
        quantity: 15,
        sku: '1118',
        slug: 'tray-table-kensington-red',
        updated_by: 1,
      },
    ])
    .into('products')
