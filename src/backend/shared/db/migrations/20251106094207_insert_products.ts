...
export const up = async (knex: Knex) => {
  ...
  const service = new SharpImageService(
    resolve(__dirname, './assets/kitchen_table_white_1.jpg'),
  )
  ...
  await service
    .input(resolve(__dirname, './assets/kitchen_table_white_2.jpeg'))
    .save()
  ...
  await service
    .input(resolve(__dirname, './assets/kitchen_table_white_3.jpeg'))
    .save()
  ...
  await service
    .input(resolve(__dirname, './assets/kitchen_table_white_4.jpeg'))
    .save()
    ...
    .insert([
      {
        ...
        name: 'Kitchen Table Regency White 1',
        size: image01Size,
        updated_by: 1,
      },
      {
        ...
        name: 'Kitchen Table Regency White 2',
        size: image02Size,
        updated_by: 1,
      },
      {
        ...
        name: 'Kitchen Table Regency White 3',
        size: image03Size,
        updated_by: 1,
      },
      {
        ...
        name: 'Kitchen Table Regency White 4',
        size: image04Size,
        updated_by: 1,
      },
    ])
  ...
  await knex
    .insert([
      {
        code: 'KITCHEN_TABLE_REGENCY_WHITE',
        created_by: 1,
        description:
          'Bring a touch of classic sophistication to your kitchen with the Regency Kitchen Table. Featuring beautifully crafted pedestal base, the Regency offers both style and functionality for family meals and casual gatherings.',
        name: 'Kitchen Table Regency White',
        updated_by: 1,
      },
    ])
    .into('galleries')
